sap.ui.define(['sap/ui/core/UIComponent', 'my/control/library/mockserver/MockServer'],
    ...
    var mockServerConfig = {
        SampleNameSpace : "Button",
        bLocalMockdata : false,
        bLocalMetadata : false
    };

	var Component = UIComponent.extend("my.control.library.sample.Button.Component", {

		metadata : {
			rootView : "my.control.library.sample.Button.Page",
			dependencies : {
				libs : [
					"sap.m",
                    "sap.ui.unified",
		...
		init: function () {
            ...
            this.modulePath =  (mockServerConfig.bLocalMockdata) ? "sample.Button.localService" : "mockserver";
