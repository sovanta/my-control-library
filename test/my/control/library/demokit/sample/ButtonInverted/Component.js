sap.ui.define(['sap/ui/core/UIComponent', 'my/control/library/mockserver/MockServer'],
    ...
    var mockServerConfig = {
        SampleNameSpace : "ButtonInverted",
        bLocalMockdata : false,
        bLocalMetadata : false
    };

	var Component = UIComponent.extend("my.control.library.sample.ButtonInverted.Component", {

		metadata : {
			rootView : "my.control.library.sample.ButtonInverted.Page",
			dependencies : {
				libs : [
					"sap.m",
                    "sap.ui.unified",
		...
		init: function () {
            ...
            this.modulePath =  (mockServerConfig.bLocalMockdata) ? "sample.ButtonInverted.localService" : "mockserver";
