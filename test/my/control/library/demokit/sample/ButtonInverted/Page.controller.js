sap.ui.define(
	...
	function(MessageToast, Controller, ODataModel, JSONModel, Button) {
		...
		var PageController = Controller.extend("my.control.library.sample.ButtonInverted.Page", {
			onInit: function() {
			...
			onAfterRendering: function() {
				...
				var head = $("head");
				var linkToStyling = jQuery.sap.getModulePath("my.control.library.sample.ButtonInverted") + "/styling.css";
