sap.ui.define(['sap/ui/core/UIComponent', 'my/control/library/mockserver/MockServer'],
    ...
    var mockServerConfig = {
        SampleNameSpace : "Cube",
        bLocalMockdata : false,
        bLocalMetadata : false
    };

	var Component = UIComponent.extend("my.control.library.sample.Cube.Component", {

		metadata : {
			rootView : "my.control.library.sample.Cube.Page",
			dependencies : {
				libs : [
					"sap.m",
                    "sap.ui.unified",
		...
		init: function () {
            ...
            this.modulePath =  (mockServerConfig.bLocalMockdata) ? "sample.Cube.localService" : "mockserver";
