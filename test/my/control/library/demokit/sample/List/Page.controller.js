sap.ui.define(
	...
	function(MessageToast, Controller, ODataModel, JSONModel, List) {
		...
		var PageController = Controller.extend("my.control.library.sample.List.Page", {
			onInit: function() {
				...
				var oModelProducts = new JSONModel(
					jQuery.sap.getModulePath("my.control.library.sample.List") + "/localService/mockdata/SampleMockdata.json"
				);
			...
			onAfterRendering: function() {
				...
				var head = $("head");
				var linkToStyling = jQuery.sap.getModulePath("my.control.library.sample.List") + "/styling.css";
