sap.ui.define(["sap/ui/core/UIComponent", "my/control/library/mockserver/MockServer"], function(UIComponent, MockServer) {
	...
	var mockServerConfig = {
		SampleNameSpace: "ListItemCounterProp",
		bLocalMockdata: false,
		bLocalMetadata: false
	};

	var Component = UIComponent.extend("my.control.library.sample.ListItemCounterProp.Component", {
		metadata: {
			rootView: "my.control.library.sample.ListItemCounterProp.Page",
			dependencies: {
		...
		init: function() {
			...
			this.modulePath = mockServerConfig.bLocalMockdata ? "sample.ListItemCounterProp.localService" : "mockserver";
