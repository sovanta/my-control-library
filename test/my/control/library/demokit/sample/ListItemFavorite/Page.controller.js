sap.ui.define(
	...
	function(MessageToast, Controller, ODataModel, JSONModel, ListItem) {
		...
		var PageController = Controller.extend("my.control.library.sample.ListItemFavorite.Page", {
			onInit: function() {
				...
				var oModelProducts = new JSONModel(
					jQuery.sap.getModulePath("my.control.library.sample.ListItemFavorite") +
			...
			onAfterRendering: function() {
				...
				var head = $("head");
				var linkToStyling = jQuery.sap.getModulePath("my.control.library.sample.ListItemFavorite") + "/styling.css";
