sap.ui.define(["sap/ui/core/UIComponent", "my/control/library/mockserver/MockServer"], function(UIComponent, MockServer) {
	...
	var mockServerConfig = {
		SampleNameSpace: "ListItemIcon",
		bLocalMockdata: false,
		bLocalMetadata: false
	};

	var Component = UIComponent.extend("my.control.library.sample.ListItemIcon.Component", {
		metadata: {
			rootView: "my.control.library.sample.ListItemIcon.Page",
			dependencies: {
		...
		init: function() {
			...
			this.modulePath = mockServerConfig.bLocalMockdata ? "sample.ListItemIcon.localService" : "mockserver";
