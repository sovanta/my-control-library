sap.ui.define(["sap/ui/core/UIComponent", "my/control/library/mockserver/MockServer"], function(UIComponent, MockServer) {
	...
	var mockServerConfig = {
		SampleNameSpace: "ListNoDataControl",
		bLocalMockdata: false,
		bLocalMetadata: false
	};

	var Component = UIComponent.extend("my.control.library.sample.ListNoDataControl.Component", {
		metadata: {
			rootView: "my.control.library.sample.ListNoDataControl.Page",
			dependencies: {
		...
		init: function() {
			...
			this.modulePath = mockServerConfig.bLocalMockdata ? "sample.ListNoDataControl.localService" : "mockserver";
