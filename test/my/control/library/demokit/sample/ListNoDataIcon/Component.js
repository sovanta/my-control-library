sap.ui.define(["sap/ui/core/UIComponent", "my/control/library/mockserver/MockServer"], function(UIComponent, MockServer) {
	...
	var mockServerConfig = {
		SampleNameSpace: "ListNoDataIcon",
		bLocalMockdata: false,
		bLocalMetadata: false
	};

	var Component = UIComponent.extend("my.control.library.sample.ListNoDataIcon.Component", {
		metadata: {
			rootView: "my.control.library.sample.ListNoDataIcon.Page",
			dependencies: {
		...
		init: function() {
			...
			this.modulePath = mockServerConfig.bLocalMockdata ? "sample.ListNoDataIcon.localService" : "mockserver";
