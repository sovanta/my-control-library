sap.ui.define(["sap/ui/core/UIComponent", "my/control/library/mockserver/MockServer"], function(UIComponent, MockServer) {
	...
	var mockServerConfig = {
		SampleNameSpace: "ListNoDataImage",
		bLocalMockdata: false,
		bLocalMetadata: false
	};

	var Component = UIComponent.extend("my.control.library.sample.ListNoDataImage.Component", {
		metadata: {
			rootView: "my.control.library.sample.ListNoDataImage.Page",
			dependencies: {
		...
		init: function() {
			...
			this.modulePath = mockServerConfig.bLocalMockdata ? "sample.ListNoDataImage.localService" : "mockserver";
