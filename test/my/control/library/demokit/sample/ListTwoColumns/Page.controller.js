sap.ui.define(
	...
	function(MessageToast, Controller, ODataModel, JSONModel, List) {
		...
		var PageController = Controller.extend("my.control.library.sample.ListTwoColumns.Page", {
			onInit: function() {
				...
				var oModelProducts = new JSONModel(
					jQuery.sap.getModulePath("my.control.library.sample.ListTwoColumns") +
			...
			onAfterRendering: function() {
				...
				var head = $("head");
				var linkToStyling = jQuery.sap.getModulePath("my.control.library.sample.ListTwoColumns") + "/styling.css";
